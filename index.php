...
<!-- Mirrored from www.radiustheme.com/demo/html/auston/multi-page/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 May 2018 06:27:44 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Khushi Infotech</title>	
    <meta name="description" content="Start - Engaging for your digital needs, Start - Thriving with us, Start - Diversifying your brand. We convert your idea to a tech reality">
    <meta name="keywords" content="Software, Development, Software Development, Training, Product Development, Customization, Custom Product Development, Corporate Training, Consulting, Software Consulting, Bangalore, Bengaluru">
...
.about-us-content h2{
            ...
            <div id="slider-direction-1" class="t-cn slider-direction">
                <div class="slider-content t-cn s-tb slider-1">
                    <div class="title-container s-tb-c title-compress">
                        <div class="medium-text">Welcome to</div>
                        <div class="title1">Khushi-infotech</div>
							<p style="font-size:16px;">
							We provide cost effective and scalable software solutions where the conventional readily available packages do not fulfill specific business requirements.</p>
                        <div class="read-more">
                            <ul>
                                <li><a href="khushi-infotech.php">Read More <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a></li>
                                <li><a href="khushi-infotech-contact.php">Contact Us <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
	...
	<div class="header-area" id="sticker" style="height:176px">
            <div class="container">
                <div class="row">
	...
	<div class="counter-contents" data-layout="4"><div class="section-content">
		<div class="row no-gutter">
			<div class="col-sm-12 col-md-6 col-lg-4"><div class="counter-item counter-item-" style="background-color: #3498db"><!--<i class="fa fa-cogs fa-3x"></i>--><img src="img/start.png" class="center"><span class="counter-title text-center">Engaging for your digital needs</span><div class="counter__number"></div></div></div>
			<div class="col-sm-12 col-md-6 col-lg-4"><div class="counter-item counter-item-" style="background-color: #e74c3c"><img src="img/start.png" class="center"><span class="counter-title text-center">Thriving with us</span><div class="counter__number"></div></div></div>
			<div class="col-sm-12 col-md-6 col-lg-4"><div class="counter-item counter-item-" style="background-color: #e67e22"><img src="img/start.png" class="center"><span class="counter-title text-center">Diversifying your brand</span><div class="counter__number"></div></div></div>
		</div>
	</div></div>
                                    ...
                                    <div class="about-us-content">
                                        ...
                                        <div class="media single-service">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-heading"><a href="#">We are Expert</a></h3>
                                                <p>Through years of operation, we have become successful in understanding the requirements of the clients in a better manner.</p>
                                            </div>
                                        </div>
                                        <div class="media single-service">
                                            <a class="media-left" href="#">
                                        ...
                                        <div class="media single-service">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-heading"><a href="#">Commitment to Quality</a></h3>
                                                <p>While retaining competitive rates we never compromise on the quality of our services. </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
			 ...
			 <h2>Our Skills</h2>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="homepage-contact-faq-tab">
                      ...
                      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="background: #63B12D;">
                        01. Corporate Training 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
									  <a class="accordion-toggle" style="background: #C88818;" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
									  <a class="accordion-toggle" style="background: #29A0CC;" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
										03.  Process Training 
									  </a>
									</h4>
                                </div>
							  ...
							  <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
									  <a class="accordion-toggle" style="background: #CCCA29;" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
										04.  Domain Training 
									  </a>
									</h4>
                                </div>
				 ...
				 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <!--<div class="skill">
                            ...
                            <div class="progress">
                                <div class="lead">CORPORATE TRAINING</div>
                            ...
                            <div class="progress">
                                <div class="lead">TECHNICAL TRAINING</div>
                            ...
                            <div class="progress">
                                <div class="lead">PROCESS TRAINING</div>
							...
							<div class="progress">
                                <div class="lead">DOMAIN TRAINING</div>
