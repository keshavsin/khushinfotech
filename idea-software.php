                ...
                <div class="homepage-new">                    
                    <div class="rc-carousel homepage-total-news-area" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="2" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="3" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="3" data-r-medium-nav="true" data-r-medium-dots="false">
                        <div class="single-news-area">
                            <div class="media">
							 <a href="http://samiteon.com" target="_blank">
                                <div class="pull-left">
                                        <img src="img/news/samiteon.jpg" alt="Samiteon company">
                                       <!-- <span>30 <br/>May </span>
                        ...
                        <div class="single-news-area">
                            <div class="media">
                                <div class="pull-left">
                                    <a href="https://lmats.com.au/" target="_blank">
                                        <img src="img/news/lmats-company.png" alt="LMATS">
                                        <!--<span>30 <br/>May </span>
                                        <i class="fa fa-plus"></i>-->
                                    </a>
                                </div>
                                <div class="media-body">
                                    <h3><a href="https://lmats.com.au/" target="_blank">LMATS</a></h3>
                                    <p>LMATS has been extensively and rapidly accepted in the industry as a reliable testing and inspection services provider because several customers recommend other companies to utilize LMATS services.  Concurrently, LMATS consistently delivered quality services to exceed customer's satisfaction.</p>
                                    <!--<p class="date"><a href="#">Admin</a> / <a href="#">(0) Comment</a></p>-->
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="media">
                                <div class="pull-left">
                                    <a href="http://www.harshayoga.com" target="_blank">
                                        <img src="img/news/harsha-yoga.jpg" alt="Harsha-yoga">
                                       <!-- <span>30 <br/>May </span>
                                        <i class="fa fa-plus"></i>-->
                                    </a>
                                </div>
